...
#                          api_v1_parks GET    /api/v1/parks(.:format)                                                                  api/v1/parks#index
#                                       POST   /api/v1/parks(.:format)                                                                  api/v1/parks#create
#                           api_v1_park GET    /api/v1/parks/:id(.:format)                                                              api/v1/parks#show
#                                       PATCH  /api/v1/parks/:id(.:format)                                                              api/v1/parks#update
#                                       PUT    /api/v1/parks/:id(.:format)                                                              api/v1/parks#update
#                                       DELETE /api/v1/parks/:id(.:format)                                                              api/v1/parks#destroy
